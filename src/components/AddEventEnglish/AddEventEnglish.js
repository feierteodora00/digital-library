...
/**
 * A from that can be used in order to fill in events in the English language.
 * 
 ...
 */
class AddEventEnglish extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        && this.state.event_description.length > 5 && this.state.event_date.length > 9 && this.state.event_date.length < 11){
            ...
            alert('The English form has sumbmitted.')
    ...
    render() {    
        ...
        return (
            <div>
                <form className="addEvents" id="form1" onSubmit={this.handleSubmit} >
                    <input
                        type='text'
...
export default AddEventEnglish;
